    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['method' => 'DELETE', 'route' => ['admin::comments.destroy', ''], 'class' => 'form-delete']) !!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">{{ $page }}</h4>
                </div>
                <div class="modal-body">
                    <strong class="lead">Are you sure want to delete this data?</strong>
                    <p class="small text-muted">*All related data will be deleted</p>
                </div>
